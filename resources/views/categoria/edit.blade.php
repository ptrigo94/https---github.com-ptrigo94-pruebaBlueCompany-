...
<body>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <form action="{{url('/categorias/'.$categoria->id)}}" method="post" enctype="multipart">
            @csrf
            {{method_field('PATCH')}}

            <div class="modal-body">
              <div class="form-group">
                <label for="nombreCategoriaEdit">Nombre Categoria</label>
                <input type="text" name="nombreCategoriaEdit" class="form-control" id="nombreCategoriaEdit" placeholder="{{$categoria->nombre}}" required>
              </div>
  ...
  <script>
    function validate() {
  var element = document.getElementById('nombreCategoriaEdit');
