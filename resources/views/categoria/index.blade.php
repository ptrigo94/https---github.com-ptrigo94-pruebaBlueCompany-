      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{url('categorias')}}">
                    ...
                    <form action="{{('/categorias')}}" method="post" enctype="multipart">
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <input type="text" name="nombreCategoria" class="form-control" id="nombreCategoria" placeholder="Ingrese el nombre de la categoria" required>
                        </div>
          ...
          <table class="table table-striped table-sm" id="datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{url('/categorias/'.$categoria->id.'/edit')}}  " class="btn btn-success">
