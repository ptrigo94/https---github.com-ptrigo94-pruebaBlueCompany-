...
<body>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <form action="{{url('/productos/'.$producto->id)}}" method="post" enctype="multipart">
            @csrf
            {{method_field('PATCH')}}
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" name="nombreProductoEdit" class="form-control" id="nombreProductoEdit" placeholder="{{$producto->nombre}}" value="{{$producto->nombre}}" required>
              </div>
              <div class="form-group">
                <label for="precioProducto">Precio producto</label>
                <input type="number" name="precioProducto" class="form-control" id="precioProducto" placeholder="{{$producto->precio}}"value="{{$producto->precio}}" required>
              </div>
              <div class="form-group">
                <select name="categoria" id="categoria" onchange="">
  ...
  <script>
    $("#categoria").change(function() {
      ...
      if ($("#categoria option:selected").text().trim() === "Alimento") {
